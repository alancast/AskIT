    ...
    <div id="topicRecentlyAnsweredScrollable">
        <table class="table table-striped table-hover" style="table-layout: fixed; width: 323px;">
            ...
            <tbody>
                ...
                $result = mysqli_query($link,"SELECT DISTINCT my_db.Questions.Question, my_db.Questions.Username, my_db.Questions.Up FROM my_db.Questions join my_db.Answers USING(QID) WHERE Tags='Java' ORDER BY my_db.Questions.Up desc");
