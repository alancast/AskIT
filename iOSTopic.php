    ...
    <div id="topicUnansweredScrollable">
        <table class="table table-striped table-hover" style="table-layout: fixed; width: 323px;">
            ...
            <tbody>
                ...
                $result = mysqli_query($link,"SELECT * FROM my_db.Questions WHERE Tags='iOS' AND NOT EXISTS (SELECT * FROM my_db.Answers WHERE my_db.Answers.QID = my_db.Questions.QID) ORDER BY Up desc");
    ...
    <div id="topicRecentlyAnsweredScrollable">
        <table class="table table-striped table-hover" style="table-layout: fixed; width: 323px;">
            ...
            <tbody>
                ...
                $result = mysqli_query($link,"SELECT DISTINCT my_db.Questions.Question, my_db.Questions.Username, my_db.Questions.Up, my_db.Questions.QID FROM my_db.Questions join my_db.Answers USING(QID) WHERE Tags='iOS' ORDER BY my_db.Questions.Up desc");
